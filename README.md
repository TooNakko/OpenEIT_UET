...
In `offline_2.py`, instead of adding to 2 variable f0 and f1 both data in .txt file, now one variable (which is f0) will take data from the COM port. The data is the ones in that .txt files, in 1 line only.
